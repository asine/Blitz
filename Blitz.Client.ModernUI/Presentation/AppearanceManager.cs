...
namespace Blitz.Client.ModernUI.Presentation
{
        ...
        : NotifyPropertyChanged
    {
        ...
        /// </summary>
        public static readonly Uri DarkThemeSource = new Uri("/Blitz.Client.ModernUI;component/Assets/ModernUI.Dark.xaml", UriKind.Relative);
        /// <summary>
        /// The location of the light theme resource dictionary.
        /// </summary>
        public static readonly Uri LightThemeSource = new Uri("/Blitz.Client.ModernUI;component/Assets/ModernUI.Light.xaml", UriKind.Relative);
