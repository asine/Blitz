...
{
    public class EmployeeReportViewerService : ReportViewerServiceBase<GetHistoryRequest, GetHistoryResponse>
    {
        ...
        public EmployeeReportViewerService(IRequestTask requestTask, IToolBarService toolBarService)
        {
            _requestTask = requestTask;
            _toolBarService = toolBarService;

            _toolBarItems = new List<IToolBarItem>();
            _toolBarItems.Add(new ToolBarButtonItem { DisplayName = "Employee Viewer Test 1", IsVisible = false });
